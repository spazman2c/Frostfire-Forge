...
const htmlContent = `<!DOCTYPE html><html lang="en"><head><link rel="icon" type="image/ico" href="./img/icons/favicon.ico"><meta charset="UTF-8"><title>Documentation</title><link rel="stylesheet" href="css/docs.css"></head><body><div class="home-button" onclick="location.href='/'"></div><h1>Documentation</h1><ul>\n${outputLines.map(line => `<li>\n   ${line}\n</li>\n`).join('')}</ul></body></html>`;
